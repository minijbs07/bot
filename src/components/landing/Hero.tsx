...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-4 overflow-hidden bg-black">
      {/* Background Elements */}
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-32">
          ...
          >
            ...
            <h1 className="text-6xl md:text-8xl font-semibold tracking-[-0.04em] mb-8 leading-[1.1] text-white">
              Botcasso <br />
          ...
          <motion.div
            ...
            className="flex-1 relative w-full aspect-square md:aspect-auto md:h-[600px] hidden md:flex items-center justify-center"
          >
            <motion.div
              animate={{ 
                y: [0, -15, 0],
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-32 md:mt-48">
          {[
            ...
            >
              ...
              <h3 className="text-xl font-medium mb-3 tracking-tight text-white">{feature.title}</h3>
